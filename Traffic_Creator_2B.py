...
def outbound_flt():
    ...
    print(tg[39] + f5_Hour.get() + ":" + f5_Min.get() + ":00" + tg[40])
    print(tg[36])
    print(tg[41] + f6.get() + tg[42])
    print(tg[43])
    print(tg[37] + f7.get() + tg[38])
    print(tg[39] + f8_Hour.get() + ":" + f8_Min.get() + ":00" + tg[40])
    print(tg[44])
...
def return_flt():
    ...
    print(tg[39] + rf5_Hour.get() + ":" + rf5_Min.get() + ":00" + tg[40])
    print(tg[36])
    print(tg[41] + rf6.get() + tg[42])
    print(tg[43])
    print(tg[37] + rf7.get() + tg[38])
    print(tg[39] + rf8_Hour.get() + ":" + rf8_Min.get() + ":00" + tg[40])
    print(tg[44])
...
m8 = ttk.Combobox(root, font=('Arial', 10), values=['6', '10', '14', '18', '26', '33', '40'])
...
TimeMinute = ['00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16',
...
f5_Hour_label = tk.Label(root, text='Departure Hour', font=('Arial', 10), width='20', anchor="e")
f5_Hour_label.grid(row=7, column=4)
f5_Hour = ttk.Combobox(root, font=('Arial', 10), values=TimeHour)
f5_Hour.grid(row=7, column=5, padx=5, pady=3)
f5_Hour.current(0)

f5_Min_label = tk.Label(root, text='Departure Min.', font=('Arial', 10), width='20', anchor="e")
f5_Min_label.grid(row=8, column=4)
f5_Min = ttk.Combobox(root, font=('Arial', 10), values=TimeMinute)
f5_Min.grid(row=8, column=5, padx=5, pady=3)
f5_Min.current(0)

f6_label = tk.Label(root, text='Cruise Altitude', font=('Arial', 10), width='20', anchor="e")
f6_label.grid(row=9, column=4)
f6 = tk.Entry(root, font=('Arial', 10))
f6.grid(row=9, column=5, padx=5, pady=5)

f7_label = tk.Label(root, text='Arrival Port', font=('Arial', 10), width='20', anchor="e")
f7_label.grid(row=10, column=4)
f7 = tk.Entry(root, textvariable=port, font=('Arial', 10))
f7.grid(row=10, column=5, padx=5, pady=5)

f8_Hour_label = tk.Label(root, text='Arrival Hour', font=('Arial', 10), width='20', anchor="e")
f8_Hour_label.grid(row=11, column=4)
f8_Hour = ttk.Combobox(root, font=('Arial', 10), values=TimeHour)
f8_Hour.grid(row=11, column=5, padx=5, pady=3)
f8_Hour.current(0)

f8_Min_label = tk.Label(root, text='Arrival Min.', font=('Arial', 10), width='20', anchor="e")
f8_Min_label.grid(row=12, column=4)
f8_Min = ttk.Combobox(root, font=('Arial', 10), values=TimeMinute)
f8_Min.grid(row=12, column=5, padx=5, pady=3)
f8_Min.current(0)

f9_label = tk.Label(root, text='Repeat', font=('Arial', 10), width='20', anchor="e")
f9_label.grid(row=13, column=4)
f9 = ttk.Combobox(font=('Arial', 10), values=['4Hr', '6Hr', '8Hr', '24Hr', 'WEEK'])
f9.grid(row=13, column=5, padx=5, pady=5)
f9.current(3)

# Set Up Return Flight

returnflight_label = tk.Label(root, text='Return Flight', font=('Arial', 12, 'bold'), width='20', fg='blue')
returnflight_label.grid(row=14, column=5, columnspan=2, padx=5, pady=5)

rf1_label = tk.Label(root, text='Call Sign', font=('Arial', 10), width='20', anchor="e")
rf1_label.grid(row=15, column=4)
rf1 = tk.Entry(root, font=('Arial', 10))
rf1.grid(row=15, column=5, padx=5, pady=5)

rf2_label = tk.Label(root, text='Required Aircraft', font=('Arial', 10), width='20', anchor="e")
rf2_label.grid(row=16, column=4)
rf2 = tk.Entry(root, textvariable=rqf, font=('Arial', 10))
rf2.grid(row=16, column=5, padx=5, pady=5)

rf3_label = tk.Label(root, text='Flight Rules', font=('Arial', 10), width='20', anchor="e")
rf3_label.grid(row=17, column=4)
rf3 = ttk.Combobox(root, font=('Arial', 10), values=['IFR', 'VFR'])
rf3['state'] = 'readonly'
rf3.grid(row=17, column=5, padx=5, pady=5)
rf3.current(0)

rf4_label = tk.Label(root, text='Departure Port', font=('Arial', 10), width='20', anchor="e")
rf4_label.grid(row=18, column=4)
rf4 = tk.Entry(root, textvariable=port, font=('Arial', 10))
rf4.grid(row=18, column=5, padx=5, pady=5)

rf5_Hour_label = tk.Label(root, text='Departure Hour', font=('Arial', 10), width='20', anchor="e")
rf5_Hour_label.grid(row=19, column=4)
rf5_Hour = ttk.Combobox(root, font=('Arial', 10), values=TimeHour)
rf5_Hour.grid(row=19, column=5, padx=5, pady=3)
rf5_Hour.current(0)

rf5_Min_label = tk.Label(root, text='Departure Min.', font=('Arial', 10), width='20', anchor="e")
rf5_Min_label.grid(row=20, column=4)
rf5_Min = ttk.Combobox(root, font=('Arial', 10), values=TimeMinute)
rf5_Min.grid(row=20, column=5, padx=5, pady=3)
rf5_Min.current(0)

rf6_label = tk.Label(root, text='Cruise Altitude', font=('Arial', 10), width='20', anchor="e")
rf6_label.grid(row=21, column=4)
rf6 = tk.Entry(root, font=('Arial', 10))
rf6.grid(row=21, column=5, padx=5, pady=5)

rf7_label = tk.Label(root, text='Arrival Port', font=('Arial', 10), width='20', anchor="e")
rf7_label.grid(row=22, column=4)
rf7 = tk.Entry(root, font=('Arial', 10))
rf7.grid(row=22, column=5, padx=5, pady=5)

rf8_Hour_label = tk.Label(root, text='Arrival Hour', font=('Arial', 10), width='20', anchor="e")
rf8_Hour_label.grid(row=23, column=4)
rf8_Hour = ttk.Combobox(root, font=('Arial', 10), values=TimeHour)
rf8_Hour.grid(row=23, column=5, padx=5, pady=3)
rf8_Hour.current(0)

rf8_Min_label = tk.Label(root, text='Arrival Min.', font=('Arial', 10), width='20', anchor="e")
rf8_Min_label.grid(row=24, column=4)
rf8_Min = ttk.Combobox(root, font=('Arial', 10), values=TimeMinute)
rf8_Min.grid(row=24, column=5, padx=5, pady=3)
rf8_Min.current(0)

rf9_label = tk.Label(root, text='Repeat', font=('Arial', 10), width='20', anchor="e")
rf9_label.grid(row=25, column=4)
rf9 = ttk.Combobox(font=('Arial', 10), values=['4Hr', '6Hr', '8Hr', '24Hr', 'WEEK'])
rf9.grid(row=25, column=5, padx=5, pady=5)
rf9.current(3)
